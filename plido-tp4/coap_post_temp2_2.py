# (TEST) Send a POST coap msg w uri path = /temp, 
# a value of 23.5 encoded in JSON, 
...
msg.add_option(CoAP.Content_format, CoAP.Content_format_JSON)
msg.add_payload( json.dumps([23.5]) )
